----------------------------------->employees table create statment and inserting values<--------------------------------------------
...
insert into employees values
 ...
 (112,'JoseManuel','Urman','JMURMAN','515.124.4469','2006-03-07','FI_ACCOUNT','7800.00','0.00',108,100),
 ...
 (178,'Kimberely','Gran','KGRANT','011.44.1644.429263','2007-05-24','SA_REP','7000.00','0.15',149,0),
 ...
 (199,'Douglas','Gran','DGRANT','650.507.9844','2008-01-13','SH_CLERK','2600.00','0.00',124,50),
...
4. Write a query to display the name (first name and last name) for those employees who gets more salary than the employee whose ID is 163. */
...
5. Write a query to display the name (first name and last name), salary, department id, job id for those employees who works in the same designation as the employee works whose id is 169. */


select first_name,last_name,salary,department_id,job_id from employees where department_id in
(select department_id from employees where employee_id=169SELECT first_name,
       last_name,
       salary,
       department_id,
       job_id
...
7. Write a query to display the employee id, employee name (first name and last name) for all employees who earn more than the average salary. */
...
8. Write a query to display the employee name (first name and last name), employee id and salary of all employees who report to Payam. */
SELECT first_name,
       last_name,
       employee_id,
       salary
